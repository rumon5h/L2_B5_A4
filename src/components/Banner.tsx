...
const Banner = () => {
    return (
        <div className={`text-black dark:text-white p-6 text-center flex flex-col h-[70vh] justify-center `}>
            <h1 className="text-3xl mb-2 font-bold">Welcome to the Library</h1>
